...
@interface TMGPUImageMovie () <AVPlayerItemOutputPullDelegate>
{
...
@implementation TMGPUImageMovie
...
- (void)startProcessing
{
    ...
    TMGPUImageMovie __block *blockSelf = self;
...
//        decompressionAudioSettings = nil;
        AVAssetTrack* audioTrack = [audioTracks objectAtIndex:0];
        
        readerAudioTrackOutput = [AVAssetReaderTrackOutput assetReaderTrackOutputWithTrack:audioTrack outputSettings:decompressionAudioSettings];
        readerAudioTrackOutput.alwaysCopiesSampleData = YES;
...
- (void)processAsset
{
    ...
    if (reader.status == AVAssetReaderStatusReading){
     //CMSampleBufferRef audio =  [readerAudioTrackOutput copyNextSampleBuffer];
    }
    
    __unsafe_unretained TMGPUImageMovie *weakSelf = self;
